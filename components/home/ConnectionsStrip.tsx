 ...
 * -----------------------------------------------------------------------------
 * 2.2.0 (2026-01-21)
 * - [FIX] La section suit la grille du site (max-w-7xl) au lieu de full-width
 * - [IMPROVED] Header + grid alignés au même container pour cohérence visuelle
...
export default function ConnectionsStrip() {
  ...
  return (
    // Section peut rester full-bleed, mais contenu aligné à la grille globale
    <section className="w-full px-6 py-16 md:py-24">
      <div className="mx-auto w-full max-w-7xl">
        ...
        {/* Connections grid (dans le même container) */}
        ...
        {/* Discover more CTA (dans le même container) */}
        <motion.div
          initial={{ opacity: 0 }}
