 ...
 * - [FIX] Database local conforme supabase-js (Views/Functions/Enums/CompositeTypes + Relationships)
 * - [KEEP] UI/UX inchangés (sans régression)
 * 1.0.1 (2026-01-21)
 * - [FIX] TS "never" sur .update() via typage Database minimal (SupabaseClient)
 * - [FIX] ESLint no-explicit-any : suppression des casts "as any" (casts typés)
 * =============================================================================
 */
...
/**
 * Database local "compatible supabase-js" (structure attendue).
 * NOTE: Relationships vide => évite des inférences bizarres selon versions.
 */
type Database = {
  public: {
    Tables: {
