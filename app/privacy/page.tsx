 ...
 * - UI EchoWorld (identique CGU) : max-w-6xl, cards glass, ancres + sommaire
 * - SAFE : respecte background cinéma global (layout) sans surcouche sombre
 *
 * CHANGELOG
 * -----------------------------------------------------------------------------
 * 1.3.0 (2026-01-25)
 * - [UI] Copy pixel-perfect du layout CGU (mêmes classes/rythmes/composants)
 * - [FIX] Uniformisation Hero/Sommaire/Cards/CTA => rendu strictement identique
 * =============================================================================
 */
